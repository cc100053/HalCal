...
| Landscape soroban | Implemented | Fixed 7 rods, tap/drag, 黒檀と骨 ebony/bone/brass/lacquer Canvas materials on the handoff's own geometry, overshoot bead travel that snaps under reduced motion, quiet unboxed control rail, visual reading guide, sound/haptics, clear undo, and adjustable per-rod accessibility semantics |
